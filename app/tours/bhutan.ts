...
export const bhutanTours: Tour[] = [
  ...
  durationTag: "12 Days",
  startEnd: "Paro → Shingkharap → Jangothang → Lingzhi → Thimphu → Punakha → Paro",
  destinations: [
    "Paro",
    "Shingkharap",
    "Soi Thangkha",
  ...
  seoMeta: {
    ...
    keywords: [
      ...
      "high altitude Bhutan trek",
      "Neyle La Yale La pass trek",
    ],
  },
  ...
  breadcrumbs: [
    ...
    { label: "Bhutan Tours", href: "/bhutan" },
    { label: "Paro Tour Packages", href: "/bhutan/paro" },
    { label: "Jomolhari Trek Bhutan – 12 Days High-Altitude Himalayan Adventure" },
  ],
...
},
{
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Dagala Thousand Lakes Trek Bhutan – 9 Days Alpine Highland Adventure",
  type: "trekking",
  duration: "9 Days / 8 Nights",
  durationTag: "9 Days",
  startEnd: "Paro → Geynekha → Gur → Labatama → Kheri Khewa → Tshokam → Thimphu → Paro",
  destinations: [
    "Paro",
    "Geynekha",
    "Gur",
  ...
  seoMeta: {
    ...
    keywords: [
      ...
      "Dagala highlands trekking",
      "Bhutan off-beat trek",
      "Pagalabtsa La Pass trek Bhutan",
    ],
  },
  ...
  breadcrumbs: [
    ...
    { label: "Bhutan Tours", href: "/bhutan" },
    { label: "Paro Tour Packages", href: "/bhutan/paro" },
    { label: "Dagala Thousand Lakes Trek Bhutan – 9 Days Alpine Highland Adventure" },
  ],
  ...
  tourDetails: [
    ...
    {
      label: "Destinations Covered",
      value: "Paro · Geynekha · Gur · Labatama · Kheri Khewa · Tshokam · Thimphu",
    },
    {
      label: "Departure & Return Airport",
      value:
  ...
  
{
  ...
  breadcrumbs: [
    ...
    { label: "Bhutan Tours", href: "/bhutan" },
    { label: "Paro Tour Packages", href: "/bhutan/paro" },
    { label: "Glimpse of Bhutan Tour – 6 Days Paro, Thimphu & Punakha Cultural Package" },
  ],
  ...
  seoMeta: {
    ...
    keywords: [
      "Bhutan short trip 4 days",
      "Bhutan 4 day tour package",
      "Paro Thimphu short tour",
      "Tiger's Nest Thimphu tour",
      "short Bhutan cultural tour package",
    ],
  },
  ...
  breadcrumbs: [
    ...
    { label: "Bhutan Tours", href: "/bhutan" },
    { label: "Paro Tour Packages", href: "/bhutan/paro" },
    { label: "Bhutan Short Trip – 4 Days Paro & Thimphu Cultural Tour Package" },
  ],
  ...
  tourDetails: [
    ...
    {
      label: "Meals Included",
      value: "Breakfast daily; Traditional Bhutanese Dinner included on Day 3",
    },
    {
      label: "Best Time to Visit Bhutan",
      value: "March–May & September–November",
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Paro Festival Tour Bhutan – 8 Days Paro Tsechu, Thimphu & Punakha Cultural Package",
  type: "festivals",
  ...
  seoMeta: {
    ...
    keywords: [
      ...
      "Paro Tsechu mask dance tour",
      "Bhutan 8 day cultural tour",
    ],
  },
  ...
  seoMeta: {
    ...
    keywords: [
      "Best of Bhutan tour 9 days",
      "Bhutan 9 day tour package",
      "Phobjikha Valley black-necked crane tour",
      "Bhutan cultural tour Paro Thimphu Punakha",
      "Gangtey Monastery Phobjikha tour",
    ],
  },
  ...
  tourDetails: [
    { label: "Tour Duration", value: "9 Days / 8 Nights" },
    {
      label: "Destinations Covered",
      value:
        "Paro · Thimphu · Dochula Pass · Phobjikha Valley · Punakha",
    },
    {
      label: "Departure & Return Airport",
      value:
...
},
{
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Druk Path Trek – 10 Days Paro to Thimphu High-Altitude Trekking in Bhutan",
  type: "trekking",
  ...
  seoMeta: {
    ...
    keywords: [
      ...
      "Bhutan trekking tour",
      "Druk Path alpine lakes",
      "Phajoding Monastery trek",
      "Jimi Langtso lake trek",
      "Bhutan high altitude trek",
      "Tiger's Nest hike Paro",
      "Bhutan trekking package 10 days",
    ],
  },
  ...
  days: [
    ...
    },
    {
      day: 10,
      date: "Day 10",
      title: "Departure from Paro International Airport – End of Druk Path Trek",
      details: [
  ...
  tourDetails: [
    ...
    {
      label: "Best Time to Visit",
      value: "March–May (Spring Rhododendrons) & September–November (Autumn Clarity)",
    },
    { label: "Group Size", value: "Small Group – Max 16 Guests" },
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Bhutan Cultural Journey – 10 Days Paro · Thimphu · Phobjikha · Bumthang · Punakha",
  type: "cultural",
  duration: "10 Days / 9 Nights",
  durationTag: "10 Days",
  ...
  seoMeta: {
    ...
    keywords: [
      ...
      "Bumthang temples tour",
      "Trongsa Dzong Bhutan",
      "Phobjikha Valley tour",
      "Punakha Dzong tour",
      "Tiger's Nest hike Paro",
      "Bhutan tour package Paro Thimphu",
      "Ogyen Choling Palace Bhutan",
    ],
  },
  ...
  days: [
    ...
    },
    {
      day: 10,
      date: "Day 10",
      title: "Departure from Paro International Airport – End of Bhutan Cultural Journey",
      details: [
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Bhutan Luxury Tour – 11 Days Private Cultural Journey with Heritage Stays & Exclusive Experiences",
  type: "family",
  duration: "11 Days / 10 Nights",
  durationTag: "11 Days",
  ...
  days: [
    ...
    },
    {
      ...
      date: "Day 9",
      title:
        "Domestic Flight Bumthang to Paro – Ta Dzong, Rinpung Dzong & Check-in to Zhiwaling Heritage",
      details: [
    ...
    },
    {
      day: 11,
      date: "Day 11",
      title: "Departure from Paro International Airport – End of Bhutan Luxury Journey",
      details: [
  ...
  country: "Bhutan",
  place: "Paro",
  title: "Happiness Trek – 14 Days Central Bhutan Trekking & Village Immersion Journey",
  type: "Trekking",
  ...
  days: [
    ...
    },
    {
      day: 14,
      date: "Day 14",
      title: "Departure from Paro International Airport – Tashi Delek, Bhutan",
      details: [
...
},
{
  ...
  country: "Bhutan",
  place: "Phuentsholing",
  title: "From Historical to Modern Day Bhutan – 6 Days Phuentsholing · Thimphu · Paro Cultural Tour",
  type: "family",
  duration: "6 Days / 5 Nights",
  durationTag: "6 Days",
