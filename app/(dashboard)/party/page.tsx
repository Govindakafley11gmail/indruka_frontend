...
import { useSearchPartyMutations } from "./tanstack-function";
...
const tableData: BookingParty[] = Array.isArray(bookingData)
  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg space-y-6 shadow-xl dark:shadow-[0_10px_15px_-3px_rgba(255,255,255,0.1)]">
        {/* Search inputs */}
        <div className="space-y-3">
          <div className="flex flex-wrap gap-3">
            {SearchFieldsFields.map((field) => (
