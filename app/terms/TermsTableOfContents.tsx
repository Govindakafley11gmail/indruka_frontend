// components/terms/TermsTableOfContents.tsx
"use client";
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block">
        <div className="sticky top-24 rounded-2xl border border-blue-100 bg-white p-6 shadow-sm max-h-[calc(100vh-7rem)] overflow-y-auto">
